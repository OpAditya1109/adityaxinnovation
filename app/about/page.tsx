...
const TIMELINE = [
  { year: "Early 2026", title: "Founded", desc: "AdityaX Innovations was established in Pune with a clear vision — build world-class digital products for startups and businesses.", accent: "#38bdf8" },
  { year: "Mid 2026", title: "First Clients", desc: "Delivered our first web and mobile projects, earning 5-star reviews and building lasting client relationships from day one.", accent: "#a78bfa" },
  { year: "2026", title: "Service Expansion", desc: "Expanded into Shopify development, custom software, and AI integration — rapidly growing our service portfolio.", accent: "#34d399" },
  { year: "Now", title: "Growing Strong", desc: "Serving clients across India with ambitions to go global. Every project strengthens our craft and our reputation.", accent: "#f472b6" },
];
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative flex items-center justify-center">
              ...
              <div className="relative z-10 w-64 rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-sm p-8 flex flex-col items-center gap-5 text-center"
                ...
                <div>
                  <p className="font-black text-white text-xl">Est. 2026</p>
                ...
                <div className="flex justify-between w-full">
                  <div className="text-center">
                    <p className="font-bold text-sky-400 text-lg">20+</p>
                    <p className="mono-font text-[.52rem] uppercase tracking-[.1em] text-white/25">Projects</p>
                  </div>
                  <div className="w-px bg-white/[0.06]" />
                  <div className="text-center">
                    <p className="font-bold text-violet-400 text-lg">15+</p>
