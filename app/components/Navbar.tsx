      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .logo-icon-wrap::before {
          ...
          padding: 1.5px;
          background: linear-gradient(135deg, #38bdf8, transparent 40%, transparent 60%, #818cf8);
          opacity: 0;
        ...
        .logo-badge:hover .logo-icon-wrap {
          box-shadow: 0 0 24px rgba(56,189,248,0.35), 0 4px 14px rgba(0,0,0,0.35);
          transform: scale(1.06) rotate(-3deg);
        }
        .logo-badge:hover .logo-icon-wrap::before {
          opacity: 1;
        }
        .logo-img {
          width: 100%;
        ...
        .logo-badge:hover .logo-name::after {
          width: 100%;
        }
        .logo-name em {
          font-style: normal;
